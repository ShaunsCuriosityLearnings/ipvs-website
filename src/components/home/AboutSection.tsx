...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenModal, onNavigate }) => {
  return (
    <section id="about" className="py-8 sm:py-10 bg-[#F4F7FE] text-slate-800 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -bottom-6 -right-4 w-48 sm:w-60 rounded-2xl overflow-hidden shadow-2xl border-4 border-white hidden sm:block">
                <img
              ...
              <div className="absolute top-1/2 -left-6 -translate-y-1/2 w-14 h-14 bg-[#1E65FF] rounded-2xl flex items-center justify-center text-white shadow-xl shadow-[#1E65FF]/40 cursor-pointer hover:bg-[#0D47A1] transition-colors">
          ...
          <div className="lg:col-span-6 space-y-5 text-left">
            ...
            {/* Title */}
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight font-heading">
            ...
            {/* 2 Highlight Feature Boxes: Left Accent Border Styling */}
            <div className="grid sm:grid-cols-2 gap-3.5 pt-1">
              <div className="p-4 rounded-2xl bg-white border-l-4 border-l-[#1E65FF] border-y-0 border-r-0 shadow-[0_2px_12px_-2px_rgba(0,0,0,0.06)] space-y-2 hover:shadow-md transition-shadow">
                <div className="w-8 h-8 rounded-lg bg-[#1E65FF]/10 text-[#1E65FF] flex items-center justify-center font-bold">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <h4 className="text-sm font-bold text-slate-900 font-heading">Product Showcases & Launches</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Experience the latest pumps, valves, automation, instrumentation and process technologies from industry leaders.
                </p>
              </div>

              <div className="p-4 rounded-2xl bg-white border-l-4 border-l-[#0e89d0] border-y-0 border-r-0 shadow-[0_2px_12px_-2px_rgba(0,0,0,0.06)] space-y-2 hover:shadow-md transition-shadow">
                <div className="w-8 h-8 rounded-lg bg-[#0e89d0]/10 text-[#0e89d0] flex items-center justify-center font-bold">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
                <h4 className="text-sm font-bold text-slate-900 font-heading">Business Networking & Partnerships</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
